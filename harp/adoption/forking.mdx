...
Adopters run Harp as a fork: `hackutd/harp` stays generic, and each school's fork changes branding and configuration. Ideally nothing else, so merging an upstream release (`git merge v1.x.0`) stays clean year after year.
