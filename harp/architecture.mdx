...
- **SuperTokens** — authentication and OAuth (managed or self-hosted)
- **PostgreSQL** — the system of record
- **Google Cloud Storage** — resume and asset storage (optional in local dev)
- **Email** — SendGrid or SMTP for decision and notification emails
- **Web Push (VAPID)** — browser push notifications
- **Apple Wallet** — optional `.pkpass` event passes
